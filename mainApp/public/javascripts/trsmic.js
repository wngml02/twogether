    ...
    .then(jsonText => {
      ...
      if (jsonData.response.header.resultCode == "03") {
        ...
        for (let i = 0; i < items.length; i++) {
          ...
          element.innerHTML = `<b>이름:</b> ${item.trsmicNm}, <b>주소:</b> ${item.rdnmadr},<b>오픈:</b> ${item.summerOperOpenHhmm},<b>마감:</b> ${item.summerOperCloseHhmm}, <b>홈페이지 주소:</b> <a href="${item.homepageUrl}">${item.homepageUrl}</a>`;
