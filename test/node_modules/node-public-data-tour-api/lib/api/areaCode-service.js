...
const areaCode = ({ language, numOfRows, pageNo, MobileOS, MobileApp, ServiceKey, areaCode, timeout = 3000, }) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const url = (0, constants_1.getServiceUrl)({ language, service: "areaCode1" });
...
//# sourceMappingURL=areaCode-service.js.map