...
const detailInfo = ({ language, numOfRows, pageNo, MobileOS, MobileApp, ServiceKey, contentId, contentTypeId, timeout = 3000, }) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const url = (0, constants_1.getServiceUrl)({ language, service: "detailInfo1" });
...
//# sourceMappingURL=detailInfo-service.js.map